...
namespace Lockstep.Game
{
    ...
    public class SkillColliderInfo
    {
        ...
        public bool IsCircle { get { return radius > 0; } }
    }
    ...
    public class SkillPart
    {
        ...
        public LFloat startTimer { get { return startFrame * SkillPart.AnimFrameScale; } }
        ...
        [HideInInspector] public LFloat DeadTimer { get { return startTimer + interval * (otherCount + LFloat.half); } }
